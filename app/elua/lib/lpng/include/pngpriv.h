...
#  error ZLIB_VERNUM != PNG_ZLIB_VERNUM \
    ...
    * libpng makes decisions to use elua_inflateInit2 and inflateReset2 based on the
...
PNG_INTERNAL_FUNCTION(void,png_icc_set_sRGB,(
   ...
   /* 'adler' is the elua_adler32 checksum of the uncompressed profile data. It may
