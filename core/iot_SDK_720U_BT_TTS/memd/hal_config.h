 ...
 * build target
 */
#define CONFIG_BUILD_TARGET "8915DM_cat1_CSDK_BT_TTS"
 ...
 */
#define CONFIG_APPIMG_FLASH_ADDRESS 0x602C0000

/**
 * reserved NOR flash size for loadable app image
 */
#define CONFIG_APPIMG_FLASH_SIZE 0x130000
 ...
 */
#define CONFIG_FS_SYS_FLASH_ADDRESS 0x603F0000

/*+\NEW\zhuwangbin\2020.8.15\兼容1.2V, offset未定义导致CSDK无法升级问题*/
#define CONFIG_FS_SYS_FLASH_OFFSET 0x3f0000
/*-\NEW\zhuwangbin\2020.8.15\兼容1.2V, offset未定义导致CSDK无法升级问题*/
 ...
 */
#define CONFIG_APP_RAM_SIZE 0x540000
