 ...
 */
#define CONFIG_BUILD_IDENTIFY "8915DM_cat1_CSDK_BT_TTS_VOLTE-debug-DEVEL-svn2340"
...
#define CONFIG_APPIMG_FLASH_OFFSET 0x29f000
/*-\NEW\zhuwangbin\2020.8.15\兼容1.2V, offset未定义导致CSDK无法升级问题*/
/**
 * reserved NOR flash size for application
 */
#define CONFIG_APP_FLASH_SIZE 0x28F000
 ...
 */
#define CONFIG_APPIMG_FLASH_ADDRESS 0x6029F000

/**
 * reserved NOR flash size for loadable app image
 */
#define CONFIG_APPIMG_FLASH_SIZE 0xE1000
 ...
 */
#define CONFIG_FS_SYS_FLASH_ADDRESS 0x60380000

/*+\NEW\zhuwangbin\2020.8.15\兼容1.2V, offset未定义导致CSDK无法升级问题*/
#define CONFIG_FS_SYS_FLASH_OFFSET 0x380000
/*-\NEW\zhuwangbin\2020.8.15\兼容1.2V, offset未定义导致CSDK无法升级问题*/
 ...
 */
#define CONFIG_FS_SYS_FLASH_SIZE 0x120000
...
#define CONFIG_BUILD_CSDK_VOLTE
#/*-\new\czm\2020.5.23\add v1.3 csdk volte*/
